...
$query_ConsultaTel = "SELECT usuarios.telefono FROM usuarios WHERE rol='3'";
$ConsultaTel = mysql_query($query_ConsultaTel, $conexion) or die(mysql_error());
$row_ConsultaTel = mysql_fetch_assoc($ConsultaTel);
$totalRows_ConsultaTel = mysql_num_rows($ConsultaTel);
?>
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="Contenido" -->
   ...
   <table width="100%" border="1">
     ...
     <tr>
       <td><?php echo $row_ConsultaTel['telefono']; ?></td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
     </tr>
     <tr>
