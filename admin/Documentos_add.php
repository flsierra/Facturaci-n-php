...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO documentacion (descripcion, soporte) VALUES (%s, %s)",
  ...
  $insertGoTo = "Documentos_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
'width=400,heigh=150,location=no,scrollbars=yes,mnubars=no,toolbars=no,resizable=yes,fullscreen=no, status=yes')
   ...
   <h1>Insertar Documentos de la Empresa</h1>
   <p>&nbsp;</p>
   <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     <table align="center">
       <tr valign="baseline">
         <td nowrap="nowrap" align="right">Descripcion:</td>
         <td><input type="text" name="descripcion" value="" size="32" required=""/></td>
       </tr>
       <tr valign="baseline">
         <td nowrap="nowrap" align="right">Soporte:</td>
         <td><input type="text" name="soporte" value="" size="32" /><input type="button" name="button" id="button" value="Subir Documento" onclick="javascpript:subirdoc();"/></td>
       </tr>
       <tr valign="baseline">
